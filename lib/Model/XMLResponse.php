...
/**
 * XMLResponse Class Doc Comment
 *
 * @category Class
 * @description XML endpoint response
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class XMLResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'XMLResponse';
    ...
    {
        $this->container['xml_document'] = isset($data['xml_document']) ? $data['xml_document'] : null;
    }
    ...
    {
        return $this->container['xml_document'];
    }

    /**
     * Sets xml_document
     *
     * @param string $xml_document XMl
     *
     * @return $this
     */
    public function setXmlDocument($xml_document)
    {
        $this->container['xml_document'] = $xml_document;

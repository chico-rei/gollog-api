...
/**
 * TrackTransportOrderRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TrackTransportOrderRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TrackTransportOrderRequest';
    ...
    const TYPE_DOCUMENT_NUMBER = 'DocumentNumber';
     ...
     * Sets value
     *
     * @param string $value Transport order document number.
     *
     * @return $this
     */
